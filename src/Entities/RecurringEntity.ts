...
export class RecurringEntity<TResult extends IRecurringEntity>
  ...
  public create():RecurringBuilder<TResult> {
  ...
  public delete(force = false, ):RecurringBuilder<TResult> {
  ...
  public saveChanges():RecurringBuilder<TResult> {
